...
-- ----------------------------
ALTER TABLE "contracts"
    ADD CONSTRAINT "contracts_contract_type_id" FOREIGN KEY ("contract_type_id") REFERENCES "contract_types" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "contracts"
    ADD CONSTRAINT "contracts_creator_id" FOREIGN KEY ("creator_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "contracts"
    ADD CONSTRAINT "contracts_gen_job_title_id" FOREIGN KEY ("gen_job_title_id") REFERENCES "gen_job_titles" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "contracts"
    ADD CONSTRAINT "contracts_gen_officer_level_id" FOREIGN KEY ("gen_officer_level_id") REFERENCES "gen_officer_levels" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "contracts"
    ADD CONSTRAINT "contracts_gen_work_location_id" FOREIGN KEY ("gen_work_location_id") REFERENCES "gen_work_locations" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "contracts"
    ADD CONSTRAINT "contracts_user_id" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "roles_permissions"
    ADD CONSTRAINT "role_fk_p" FOREIGN KEY ("role_id") REFERENCES "roles" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table uploadables
-- ----------------------------
ALTER TABLE "uploadables"
    ADD CONSTRAINT "uploadables_gen_upload_id" FOREIGN KEY ("gen_upload_id") REFERENCES "gen_uploads" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table user_activities
-- ----------------------------
ALTER TABLE "user_activities"
    ADD CONSTRAINT "user_activities_user_id" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table user_certificates
-- ----------------------------
ALTER TABLE "user_certificates"
    ADD CONSTRAINT "user_certificates_user_id" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table user_courses
-- ----------------------------
ALTER TABLE "user_courses"
    ADD CONSTRAINT "user_courses_user_id" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table user_profiles
-- ----------------------------
ALTER TABLE "user_profiles"
    ADD CONSTRAINT "user_profiles_user_id" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- ----------------------------
ALTER TABLE "setting_themes"
    ADD CONSTRAINT "setting_themes_user_id" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
