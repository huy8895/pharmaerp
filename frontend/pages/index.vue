                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar-xs me-2 flex-shrink-0">
                          <div class="avatar-title bg-soft-secondary rounded">
                            <img src="/velzon/assets/images/companies/img-1.png" alt="" height="16">
                          </div>
                        </div>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar-xs me-2 flex-shrink-0">
                          <div class="avatar-title bg-soft-warning rounded">
                            <img src="/velzon/assets/images/companies/img-3.png" alt="" height="16">
                          </div>
                        </div>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar-xs me-2 flex-shrink-0">
                          <div class="avatar-title bg-soft-primary rounded">
                            <img src="/velzon/assets/images/companies/img-2.png" alt="" height="16">
                          </div>
                        </div>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar-xs me-2 flex-shrink-0">
                          <div class="avatar-title bg-soft-danger rounded">
                            <img src="/velzon/assets/images/companies/img-4.png" alt="" height="16">
                          </div>
                        </div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="avatar-xs me-2 flex-shrink-0">
                          <div class="avatar-title bg-soft-danger rounded">
                            <img src="/velzon/assets/images/companies/img-5.png" alt="" height="16">
                          </div>
                        </div>
                    ...
                    <ul class="list-unstyled mb-0 pt-2" id="candidate-list">
                      <li>
                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                          ...
                          <div class="flex-grow-1">
                            <h5 class="fs-13 mb-1 text-truncate"><span class="candidate-name">Tonya Noble</span> <span
                      ...
                      <li>
                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                          <div class="flex-shrink-0 me-2">
                            <div class="avatar-xs">
                              <img src="/velzon/assets/images/users/avatar-1.jpg" alt=""
                                   class="img-fluid rounded-circle candidate-img">
                            </div>
                          </div>
                          <div class="flex-grow-1">
                            <h5 class="fs-13 mb-1 text-truncate"><span class="candidate-name">Nicholas Ball</span>
                              <span class="text-muted fw-normal">@nicholas</span></h5>
                      ...
                      <li>
                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                          <div class="flex-shrink-0 me-2">
                            <div class="avatar-xs">
                              <img src="/velzon/assets/images/users/avatar-9.jpg" alt=""
                                   class="img-fluid rounded-circle candidate-img">
                            </div>
                          </div>
                          <div class="flex-grow-1">
                            <h5 class="fs-13 mb-1 text-truncate"><span class="candidate-name">Zynthia Marrow</span>
                              <span class="text-muted fw-normal">@zynthia</span></h5>
                      ...
                      <li>
                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                          ...
                          <div class="flex-grow-1">
                            <h5 class="fs-13 mb-1 text-truncate"><span class="candidate-name">Cheryl Moore</span>
                              <span class="text-muted fw-normal">@Cheryl</span></h5>
                      ...
                      <li>
                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                          ...
                          <div class="flex-grow-1">
                            <h5 class="fs-13 mb-1 text-truncate"><span class="candidate-name">Jennifer Bailey</span>
                              <span class="text-muted fw-normal">@Jennifer</span></h5>
                      ...
                      <li>
                        <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                          ...
                          <div class="flex-grow-1">
                            <h5 class="fs-13 mb-1 text-truncate"><span class="candidate-name">Hadley Leonard</span>
                              <span class="text-muted fw-normal">@hadley</span></h5>
              ...
              <div class="col-lg-6">
                <div class="card-body text-center">
                  <div class="avatar-md mb-3 mx-auto">
                    <img src="/velzon/assets/images/users/avatar-10.jpg" alt="" id="candidate-img"
                  ...
                  <div>
                    <button type="button" class="btn btn-success custom-toggle w-100" data-bs-toggle="button"
                            aria-pressed="false">
            ...
            <div class="card-body bg-soft-danger">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                  ...
                  <p class="text-muted mb-0">Nor again is there anyone who loves or pursues or desires to obtain pain
                    of itself, because it is pain, but because occasionally.</p>
                </div>
              </div>
                ...
                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 me-2">
                          <img src="/velzon/assets/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle"/>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 me-2">
                          <img src="/velzon/assets/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle"/>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 me-2">
                          <img src="/velzon/assets/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle"/>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 me-2">
                          <img src="/velzon/assets/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-circle"/>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 me-2">
                          <img src="/velzon/assets/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle"/>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 me-2">
                          <img src="/velzon/assets/images/users/avatar-10.jpg" alt="" class="avatar-xs rounded-circle"/>
                        </div>
                    ...
                    <td>
                      <h5 class="fs-14 fw-medium mb-0">4.7<span class="text-muted fs-11 ms-1">(3.21k Rating)</span>
                      </h5>
                    </td>
                  </tr><!-- end tr -->
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 me-2">
                          <img src="/velzon/assets/images/users/avatar-8.jpg" alt="" class="avatar-xs rounded-circle"/>
                        </div>
                    ...
                    <td>
                      <h5 class="fs-14 fw-medium mb-0">4.7<span class="text-muted fs-11 ms-1">(2.93k Rating)</span>
                      </h5>
                    </td>
                  </tr><!-- end tr -->
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 me-2">
                          <img src="/velzon/assets/images/users/avatar-9.jpg" alt="" class="avatar-xs rounded-circle"/>
                        </div>
                    ...
                    <td>
                      <h5 class="fs-14 fw-medium mb-0">4.7<span class="text-muted fs-11 ms-1">(4.31k Rating)</span>
                      </h5>
                    </td>
                  </tr><!-- end tr -->
                  </tbody><!-- end tbody -->
