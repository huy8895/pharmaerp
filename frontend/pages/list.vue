<template>
  <div>
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h2 class="mt-4 ff-secondary"><span class="counter-value" data-target="547">547</span>k</h2>
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h2 class="mt-4 ff-secondary"><span class="counter-value" data-target="124">124</span>k</h2>
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h2 class="mt-4 ff-secondary"><span class="counter-value" data-target="107">107</span>K</h2>
                  <p class="mb-0 text-muted"><span class="badge bg-light text-danger mb-0">
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <h2 class="mt-4 ff-secondary"><span class="counter-value" data-target="15.95">15.95</span>%</h2>
                  <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0">
                ...
                <div class="flex-shrink-0">
                  <div class="d-flex flex-wrap gap-2">
                    <button class="btn btn-danger add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i
                      class="ri-add-line align-bottom me-1"></i> Create Tickets
                    </button>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          <li>
                            <button class="dropdown-item" onclick="location.href = 'apps-tickets-details.html';"><i
                ...
                <div class="row g-3">
                  ...
                  <div class="col-lg-6">
                    <div>
                      ...
                      <input type="text" id="client_nameName-field" class="form-control" placeholder="Client Name"
                             required/>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div>
                      ...
                      <input type="text" id="assignedtoName-field" class="form-control" placeholder="Assigned to"
                             required/>
                    </div>
                  </div>
                  <div class="col-lg-6">
    ...
    <script src="/velzon/assets/js/pages/ticketlist.init.js"></script>
  </div>
</template>
