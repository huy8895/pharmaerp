...
export default {
  ...
  methods: {
    ...
    addnew() {
      ...
      this.tagvalue = null;
      document.getElementById("addform").reset();
      document.querySelector('.exampleModalLabel').innerHTML = "Add Example";
...
<template>
  <Layout>
              ...
              <b-col sm="auto" class="ms-auto">
                <div class="hstack gap-2">
                  ...
                  <b-button type="button" variant="success" class="add-btn" id="create-btn" @click="addnew">
                    <i class="ri-add-line align-bottom me-1"></i> Add Example
                  </b-button>
                  <span class="dropdown">
              ...
              <div class="table-responsive table-card">
                <table class="table align-middle" id="customerTable">
                  ...
                  <tr>
                    ...
                    <th class="sort" data-sort="leads_score">Example Score</th>
                    ...
                    <b-row class="g-2">
                      <b-col lg="6">
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="inlineCheckbox1">New Example</label>
                        </div>
                      </b-col>
                      <b-col lg="6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2" />
                          <label class="form-check-label" for="inlineCheckbox2">Old Example</label>
                        </div>
                      </b-col>
                      <b-col lg="6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3" />
                          <label class="form-check-label" for="inlineCheckbox3">Loss Example</label>
                        </div>
                      </b-col>
                      <b-col lg="6">
                        <div class="form-check">
                    ...
                    <b-row class="g-3">
                      ...
                      <b-col lg="6">
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="lead">Example</label>
                        </div>
                      </b-col>
                      <b-col lg="6">
                        <div class="form-check">
    ...
    <b-modal v-model="addExampleModal" id="showmodal" hide-footer title-class="exampleModalLabel"
      ...
      <b-form action="" id="addform" class="tablelist-form" autocomplete="off">
        ...
        <b-row class="g-3">
          ...
          <b-col lg="6">
            <div>
              <label for="leads_score-field" class="form-label">Example Score</label>
        ...
        <div class="modal-footer v-modal-footer mt-3">
          <div class="hstack gap-2 justify-content-end">
            <b-button type="button" variant="light" id="closemodal" @click="addExampleModal = false">Close</b-button>
