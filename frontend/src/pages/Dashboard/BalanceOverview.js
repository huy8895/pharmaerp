...
import { BalanceOverviewCharts } from "./DashboardCharts";
import { getBalanceOverviewChartsData } from '../../store/dashboard/action';
...
const BalanceOverview = () => {
    ...
    const { balanceOverviewData } = useSelector(state => ({
        balanceOverviewData: state.Dashboard.balanceOverviewData
    }));
