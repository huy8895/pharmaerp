...
public abstract  class BaseFilterService<ENTITY extends BaseCRUDEntity, C extends BaseCrudCriteria<ENTITY>> extends QueryService<ENTITY>{
	
	@Transactional(readOnly = true)
	public Page<ENTITY> findByCriteria(C criteria, Pageable page, BiFunction<Specification<ENTITY>, Pageable, Page<ENTITY>> findAll) {
	...
	abstract protected Specification<ENTITY> createSpecification(C criteria);
