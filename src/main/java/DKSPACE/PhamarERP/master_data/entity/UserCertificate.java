...
public class UserCertificate {
	...
	public Boolean getHasNoExpirationDate() {
		return hasNoExpirationDate;
	}
	
	public void setHasNoExpirationDate(Boolean hasNoExpirationDate) {
		this.hasNoExpirationDate = hasNoExpirationDate;
	}
